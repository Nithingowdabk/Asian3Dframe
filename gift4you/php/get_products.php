...
<head>
  ...
  <title>Asian3DFrames – Frame Your Memories</title>
  <link rel="stylesheet" href="assets/css/style.css?v=20260407s"/>
  <link rel="preconnect" href="https://fonts.googleapis.com"/>
  <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin/>
  <link href="https://fonts.googleapis.com/css2?family=Playfair+Display:wght@700&family=Inter:wght@400;600&display=swap" rel="stylesheet"/>
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css"/>
</head>
<body style="background-color: #f4f4f4; font-family: 'Inter', sans-serif; color: #333;">
  ...
  <section class="hero" id="hero" style="background: linear-gradient(to right, #d69e2e, #f4f4f4); padding: 60px 0; text-align: center;">
    ...
    <div class="hero-btns">
      <a href="products.html" class="btn btn-primary" style="background-color: #d69e2e; color: #fff; padding: 10px 20px; border-radius: 5px;">
        Shop Now <i class="fas fa-arrow-right"></i>
      </a>
      <a href="#upload-section" class="btn btn-ghost" style="border: 2px solid #fff; color: #fff; padding: 10px 20px; border-radius: 5px;">
        <i class="fas fa-upload"></i> Custom Photo Frame
      </a>
    </div>
  </section>

  <div class="marquee-strip" style="background-color: #d69e2e; color: #fff; padding: 10px 0;">
  ...
  <section class="section categories-section" style="padding: 40px 0;">
    <div class="container">
      <div class="section-header">
        ...
        <h2 class="section-title" style="font-family: 'Playfair Display', serif; color: #333;">Shop by Style</h2>
        <p class="section-sub" style="color: #666;">Fresh picks every visit: floating category bubbles for your moments.</p>
      </div>

      <div class="categories-grid" id="homeCategoriesGrid">
        <a href="products.html?category=mobile" class="cat-card" style="border: 1px solid #d69e2e; border-radius: 10px; overflow: hidden;">
          <div class="cat-img-wrap">
            <img src="assets/images/cat-classic.jpg" alt="Mobile Photo Frame" style="width: 100%;"/>
          </div>
          <div class="cat-info" style="padding: 10px;">
            <h3 style="color: #333;">Mobile Photo Frame</h3>
          </div>
        </a>
        <a href="products.html?category=normal" class="cat-card" style="border: 1px solid #d69e2e; border-radius: 10px; overflow: hidden;">
          <div class="cat-img-wrap">
            <img src="assets/images/cat-modern.jpg" alt="Normal Photo Frame" style="width: 100%;"/>
          </div>
          <div class="cat-info" style="padding: 10px;">
            <h3 style="color: #333;">Normal Photo Frame</h3>
          </div>
        </a>
      </div>
    </div>
      ...
      <div class="footer-grid">
        <div class="footer-brand">
          ...
          <div class="social-links">
            <a href="#" class="social-btn" style="color: #fff;"><i class="fab fa-facebook-f"></i></a>
            <a href="#" class="social-btn" style="color: #fff;"><i class="fab fa-instagram"></i></a>
            <a href="#" class="social-btn" style="color: #fff;"><i class="fab fa-tiktok"></i></a>
            <a href="#" class="social-btn" style="color: #fff;"><i class="fab fa-whatsapp"></i></a>
          </div>
        </div>
        ...
        <div class="footer-col">
          ...
          <ul class="contact-list">
            <li><i class="fas fa-phone" style="color: #d69e2e;"></i> 01012345678</li>
            <li><i class="fab fa-whatsapp" style="color: #d69e2e;"></i> 6362639150</li>
            <li><i class="fas fa-envelope" style="color: #d69e2e;"></i> hello@asian3dframes.com</li>
            <li><i class="fas fa-clock" style="color: #d69e2e;"></i> Daily 9 AM – 9 PM</li>
          </ul>
        </div>
      </div>
